...
fn test_s32_trailing_zeros_algorithm(id: u64, desc: String, switches: Vec<String>) {
	// prepare
...
// test suites
hestia_testing_exec!(test_s32_trailing_zeros_bits_0, {
	test_s32_trailing_zeros_algorithm(
		3,
		"\
test hestia_number::hestia_bits::s32_trailing_zeros() is able to process 0-bits value.
"
		.to_string(),
...
hestia_testing_exec!(test_s32_trailing_zeros_bits_8, {
	test_s32_trailing_zeros_algorithm(
		2,
		"\
test hestia_number::hestia_bits::s32_trailing_zeros() is able to process 8-bits value.
"
		.to_string(),
...
hestia_testing_exec!(test_s32_trailing_zeros_bits_16, {
	test_s32_trailing_zeros_algorithm(
		1,
		"\
test hestia_number::hestia_bits::s32_trailing_zeros() is able to process 16-bits value.
"
		.to_string(),
...
hestia_testing_exec!(test_s32_trailing_zeros_bits_32, {
	test_s32_trailing_zeros_algorithm(
		0,
		"\
test hestia_number::hestia_bits::s32_trailing_zeros() is able to process 32-bits value.
"
		.to_string(),
