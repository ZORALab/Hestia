...
fn assert_output(s: &hestia_testing::Scenario, output: u64) -> bool {
	if hestia_testing::has_condition(s, testlibs_test::COND_BITS_64) {
		return output == testlibs_test::VALUE_BITS_64_COUNT as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_BITS_32) {
		return output == testlibs_test::VALUE_BITS_32_COUNT as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_BITS_16) {
		return output == testlibs_test::VALUE_BITS_16_COUNT as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_BITS_8) {
		return output == testlibs_test::VALUE_BITS_8_COUNT as u64;
	}
...
// test suites
hestia_testing_exec!(test_s64_length_bits_0, {
...
hestia_testing_exec!(test_s64_length_bits_8, {
	test_s64_length_algorithm(
		3,
		"\
...
hestia_testing_exec!(test_s64_length_bits_16, {
	test_s64_length_algorithm(
		2,
		"\
...
hestia_testing_exec!(test_s64_length_bits_32, {
	test_s64_length_algorithm(
		1,
		"\
...
hestia_testing_exec!(test_s64_length_bits_64, {
	test_s64_length_algorithm(
		0,
		"\
