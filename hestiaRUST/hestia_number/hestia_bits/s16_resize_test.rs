...
// test suites
const SUITE_NAME: &str = "hestia_number::hestia_bits::s16_resize API";
...
fn assert_output(s: &hestia_testing::Scenario, output: u16) -> bool {
	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_1000) {
		return output == constants::MAX_UINT128 as u16;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_16) {
		if hestia_testing::has_condition(s, testlibs_test::COND_TO_SIGNED) {
			return output == constants::MAX_INT16 as u16;
		} else {
			return output == constants::MAX_UINT16 as u16;
		}
	}
	...
	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_8) {
		if hestia_testing::has_condition(s, testlibs_test::COND_TO_SIGNED) {
			return output == constants::MAX_INT8 as u16;
		} else {
			return output == constants::MAX_UINT8 as u16;
		}
	}
...
fn test_s16_resize_algorithm(id: u64, desc: String, switches: Vec<String>) {
	// prepare
	...
	let err: Error = hestia_bits::s16_resize(&mut subject, size, sign);
...
// test suites
hestia_testing_exec!(test_s16_resize_bits_16_to_signed_0, {
	test_s16_resize_algorithm(
		10,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to signed
0-bits value.
"
		.to_string(),
		vec![
...
hestia_testing_exec!(test_s16_resize_bits_16_to_unsigned_0, {
	test_s16_resize_algorithm(
		9,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
0-bits value.
"
		.to_string(),
		vec![
...
hestia_testing_exec!(test_s16_resize_bits_16_to_signed_5, {
	test_s16_resize_algorithm(
		8,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to signed
...
hestia_testing_exec!(test_s16_resize_bits_16_to_unsigned_5, {
	test_s16_resize_algorithm(
		7,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
...
hestia_testing_exec!(test_s16_resize_bits_16_to_signed_8, {
	test_s16_resize_algorithm(
		6,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
...
hestia_testing_exec!(test_s16_resize_bits_16_to_unsigned_8, {
	test_s16_resize_algorithm(
		5,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
...
hestia_testing_exec!(test_s16_resize_bits_16_to_signed_12, {
	test_s16_resize_algorithm(
		4,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to signed
...
hestia_testing_exec!(test_s16_resize_bits_16_to_unsigned_12, {
	test_s16_resize_algorithm(
		3,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
...
hestia_testing_exec!(test_s16_resize_bits_16_to_signed_16, {
	test_s16_resize_algorithm(
		2,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to signed
...
hestia_testing_exec!(test_s16_resize_bits_16_to_unsigned_16, {
	test_s16_resize_algorithm(
		1,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
...
hestia_testing_exec!(test_s16_resize_bits_16_to_unsigned_1000, {
	test_s16_resize_algorithm(
		0,
		"\
test hestia_number::hestia_bits::s16_resize() is able to process 16-bits value to unsigned
