...
// test suites
const SUITE_NAME: &str = "hestia_number::hestia_bits::s64_resize API";

// test libs
fn assert_error(s: &hestia_testing::Scenario, err: Error) -> bool {
	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_64)
		|| hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_35)
		|| hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_32)
...
fn assert_output(s: &hestia_testing::Scenario, output: u64) -> bool {
	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_1000) {
		return output == constants::MAX_UINT128 as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_64) {
		if hestia_testing::has_condition(s, testlibs_test::COND_TO_SIGNED) {
			return output == constants::MAX_INT64 as u64;
		} else {
			return output == constants::MAX_UINT64 as u64;
		}
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_35) {
		return output == testlibs_test::VALUE_TYPE_128_BITS_35 as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_32) {
		if hestia_testing::has_condition(s, testlibs_test::COND_TO_SIGNED) {
			return output == constants::MAX_INT32 as u64;
		} else {
			return output == constants::MAX_UINT32 as u64;
		}
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_22) {
		return output == testlibs_test::VALUE_TYPE_128_BITS_22 as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_16) {
		if hestia_testing::has_condition(s, testlibs_test::COND_TO_SIGNED) {
			return output == constants::MAX_INT16 as u64;
		} else {
			return output == constants::MAX_UINT16 as u64;
		}
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_12) {
		return output == testlibs_test::VALUE_TYPE_128_BITS_12 as u64;
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_8) {
		if hestia_testing::has_condition(s, testlibs_test::COND_TO_SIGNED) {
			return output == constants::MAX_INT8 as u64;
		} else {
			return output == constants::MAX_UINT8 as u64;
		}
	}

	if hestia_testing::has_condition(s, testlibs_test::COND_TO_BITS_5) {
		return output == testlibs_test::VALUE_TYPE_128_BITS_5 as u64;
	}
...
fn test_s64_resize_algorithm(id: u64, desc: String, switches: Vec<String>) {
	// prepare
	...
	let err: Error = hestia_bits::s64_resize(&mut subject, size, sign);
...
// test suites
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_0, {
	test_s64_resize_algorithm(
		18,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
0-bits value.
"
		.to_string(),
		vec![
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_0, {
	test_s64_resize_algorithm(
		17,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
0-bits value.
"
		.to_string(),
		vec![
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_5, {
	test_s64_resize_algorithm(
		16,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_5, {
	test_s64_resize_algorithm(
		15,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_8, {
	test_s64_resize_algorithm(
		14,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_8, {
	test_s64_resize_algorithm(
		13,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_12, {
	test_s64_resize_algorithm(
		12,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_12, {
	test_s64_resize_algorithm(
		11,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_16, {
	test_s64_resize_algorithm(
		10,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_16, {
	test_s64_resize_algorithm(
		9,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_22, {
	test_s64_resize_algorithm(
		8,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_22, {
	test_s64_resize_algorithm(
		7,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_32, {
	test_s64_resize_algorithm(
		6,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_32, {
	test_s64_resize_algorithm(
		5,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_35, {
	test_s64_resize_algorithm(
		4,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
"
		.to_string(),
		vec![
			String::from(testlibs_test::COND_TO_BITS_35),
			String::from(testlibs_test::COND_TO_SIGNED),
		],
	)
});

hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_35, {
	test_s64_resize_algorithm(
		3,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_signed_64, {
	test_s64_resize_algorithm(
		2,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to signed
...
"
		.to_string(),
		vec![
			String::from(testlibs_test::COND_TO_BITS_64),
			String::from(testlibs_test::COND_TO_SIGNED),
		],
	)
});

hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_64, {
	test_s64_resize_algorithm(
		1,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
...
hestia_testing_exec!(test_s64_resize_bits_64_to_unsigned_1000, {
	test_s64_resize_algorithm(
		0,
		"\
test hestia_number::hestia_bits::s64_resize() is able to process 64-bits value to unsigned
