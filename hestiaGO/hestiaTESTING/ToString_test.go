	...
	return []*Scenario{
		{
			...
			Description: `
Test ToString() able to work properly with proper Scenario settings.
`,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to panic with fault fail function registration.
`,
			Switches: map[string]bool{
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to panic with fault skip function registration.
`,
			Switches: map[string]bool{
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to panic with faulty skip and fail functions registration.
`,
			Switches: map[string]bool{
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to work properly with empty Name settings.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to work properly with empty Switches settings.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
				cond_PROPER_NAME:         true,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to work properly with nil Switches settings.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
				cond_PROPER_NAME:         true,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to work properly with empty log settings.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
				cond_PROPER_NAME:         true,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to work properly with nil log settings.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
				cond_PROPER_NAME:         true,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to work properly with empty description settings.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
				cond_PROPER_NAME:         true,
			...
			Name: suite_TO_STRING_API,
			Description: `
Test ToString() able to panic when nil Scenario is supplied.
`,
			Switches: map[string]bool{
				cond_PROPER_REGISTRATION: true,
				cond_PROPER_NAME:         true,
