...
`,
			...
			Description: `
test hestiaSTRING/S16_FormatUINT16 is able to raise error for base-37 lowercase 0 value.
`,
			Switches: []string{
				cond_BASE_37,
				cond_VALUE_ZERO,
			...
			Description: `
test hestiaSTRING/S16_FormatUINT16 is able to raise error for base-37 uppercase 0 value.
`,
			Switches: []string{
				cond_BASE_37,
				cond_VALUE_ZERO,
			...
			Description: `
test hestiaSTRING/S16_FormatUINT16 is able to process base-10 unknown-case value.
`,
			Switches: []string{
				cond_BASE_16,
				cond_VALUE_UINT64,
